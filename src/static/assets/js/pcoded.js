...
for (var t = 0; t < tc.length; t++) {
  tc[t].setAttribute("src", "static/assets/images/logo-white.svg");
}
  ...
  if (layout == "dark") {
    ...
    if (document.querySelector(".pc-sidebar .m-header .logo-lg")) {
      document
        ...
        .setAttribute("src", "static/assets/images/logo-white.svg");
    }
    ...
    if (document.querySelector(".pc-sidebar .m-header .logo-lg")) {
      document
        .querySelector(".pc-sidebar .m-header .logo-lg")
        .setAttribute("src", "static/assets/images/logo-dark.svg");
    }
    if (document.querySelector(".navbar-brand .logo-lg")) {
      document
        .querySelector(".navbar-brand .logo-lg")
