...
for (
  ...
  layout_btn[t] &&
    layout_btn[t].addEventListener("click", function (e) {
      ...
      "true" ==
      (e =
        "SPAN" == (e = "SPAN" == e.tagName ? e.parentNode : e).tagName
          ? e.parentNode
...
function layout_change(typeMode) {
  if (typeMode === "dark") {
    document
      .getElementsByTagName("body")[0]
      .setAttribute("data-pc-theme", typeMode);
    localStorage.setItem("theme", typeMode);
  } else if (typeMode === "light") {
    document
      .getElementsByTagName("body")[0]
      .setAttribute("data-pc-theme", typeMode);
    localStorage.setItem("theme", typeMode);
  ...
  //       ),
  //       updateLogo(".navbar-brand .logo-lg", "../images/logo-white.svg"),
  //       updateLogo(
  //         ".auth-main.v1 .auth-sidefooter img",
  //         "../images/logo-white.svg"
  //       ),
  //       updateLogo(".footer-top .footer-logo", "../images/logo-white.svg"),
  //       updateActiveButton('.theme-layout .btn[data-value="false"]'))
  //     : ((dark_flag = !1),
  //       updateLogo(".pc-sidebar .m-header .logo-lg", "../images/logo-dark.svg"),
