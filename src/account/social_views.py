...
from social_django.utils import maybe_require_post, psa
...
def complete(request, backend, *args, **kwargs):
    ...
    # Check if the user is authenticated after the process
    try:
        ...
        if request.user.is_authenticated:
            messages.success(
                request, "You have successfully logged in using your social account!")
        else:
