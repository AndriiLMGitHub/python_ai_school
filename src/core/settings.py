...
SOCIAL_AUTH_LOGIN_REDIRECT_URL = 'complete_user'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',  # let Django find templates in the project directory
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': 'AndreyCreatorWeb$ai_db',
        'USER': 'AndreyCreatorWeb',
        'PASSWORD': 'Andrii1212',
